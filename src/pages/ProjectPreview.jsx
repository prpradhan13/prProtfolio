...
const ProjectPreview = () => {
  ...
  return (
    <div className="w-full bg-lightBg dark:bg-darkBg flex justify-center">
      <div className="w-full lg:w-[50vw] min-h-screen relative p-5 lg:py-8 font-montserrat">
        {/* Project Name */}
        ...
        <div className="flex gap-3 mt-5">
          <button className="w-32 dark:bg-darkBtnBg dark:text-black bg-lightBtnBg text-white px-2 py-1 rounded-md text-xs md:text-sm font-semibold flex items-center justify-center gap-2">
            Screenshots <IoMdImages fontSize={16} />
          </button>
          <button onClick={() => setOpenVdo(true)} className="w-20 dark:bg-darkBtnBg dark:text-black bg-lightBtnBg text-white py-1 rounded-md text-xs md:text-sm font-semibold flex items-center justify-center gap-2">
